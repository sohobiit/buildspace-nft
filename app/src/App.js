...
import Foto from './assets/SB.png';
import { ethers } from "ethers";
import myEpicNft from './utils/MyEpicNFT.json';

// Constants
const TWITTER_HANDLE = 'sohobiit';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = 'https://testnets.opensea.io/collection';
const TOTAL_MINT_COUNT = 33;
const CONTRACT_ADDRESS = "0x5b2abf3dcCCD4cA4641faDBc8f1e6588Cf93c942";
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">CKS Soho NFT Collection</p>
        ...
        <div><img className="change-sz" src={Foto} /></div>
